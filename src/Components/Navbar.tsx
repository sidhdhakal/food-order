...
const Navbar = ({ activeComponent, sidebarOpen, setIsSidebarOpen, setIsActiveComponent }: any) => {
  ...
  return (
    <div className=" min-h-[5rem] h-[5rem] w-full md:w-[calc(100vw-8rem)] 4xl:w-[calc(100vw-16rem)] fixed top-0 shadow-md bg-zinc-50/70 backdrop-blur-lg lg:bg-zinc-50 flex justify-center items-center text-black z-[5]">
