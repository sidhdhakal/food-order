...
const SearchInput = ({className='hidden md:flex'}:{className?:string}) => {
  return (
    ...
    />
    <button className="ml-2 bg-primary-300 flex hover:bg-primary-400 transition-all duration-200 px-4 md:px-6 rounded-2xl text-black py-2 h-full absolute right-0  justify-center items-center gap-x-1 ">
      <Icon
